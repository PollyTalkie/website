    ...
    <div className="flex flex-col items-center gap-2">
      ...
      {downloadUrl && (
        <a
          ...
          className="mt-3 px-4 py-2 bg-primary text-primary-foreground text-sm font-medium rounded-md hover:bg-primary/90 transition-colors flex items-center justify-center gap-2 w-full"
        >
